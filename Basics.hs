...
[01-intro](https://github.com/cis552/01-intro) on github. We have prepared
instructions on using
[github with CIS 552](https://www.cis.upenn.edu/~cis552/current/version.html)
and with installing
[GHC and VSCode](https://www.cis.upenn.edu/~cis552/current/haskell-vscode.html).
...
other tools are available.](https://www.cis.upenn.edu/~cis552/current/haskell-vscode.html)

First use the terminal to start `ghci` and instruct it to load the `Basics`
module.

    sweirich@sixteen 01-intro % stack ghci Basics.hs
    Using configuration for cis552-intro:lib to load /Users/sweirich/552/cis552-20fa/lectures/01-intro/Basics.lhs
    cis552-intro> configure (lib)
    Configuring cis552-intro-0.1.0.0...
    cis552-intro> initial-build-steps (lib)
    Configuring GHCi with the following packages: cis552-intro
    GHCi, version 8.8.3: https://www.haskell.org/ghc/  :? for help
    [1 of 1] Compiling Basics           ( /Users/sweirich/552/cis552-20fa/lectures/01-intro/Basics.lhs, interpreted )
...
runIsLongTests :: IO Counts
runIsLongTests = runTestTT testIsLong
